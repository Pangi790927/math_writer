...
/* The idea would be that the ast would be transformed to a mathd friendly format,
for example in a tree of the form
    (mathd_e, params..., childs...)
From this, the expression would be drawn once
 */
